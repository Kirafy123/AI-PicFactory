...
export const KIE_SEEDANCE_2_FAST_MODEL_ID = 'kie/seedance-2-fast';

export const videoModel: VideoModelDefinition = {
  id: KIE_SEEDANCE_2_FAST_MODEL_ID,
  mediaType: 'video',
  displayName: 'Seedance 2 Fast (KIE)',
  providerId: 'kie',
  description: 'KIE · Seedance 2.0 Fast 快速视频生成',
  eta: '3-5min',
  ...
  resolveRequest: ({ referenceImageCount }) => ({
    requestModel: KIE_SEEDANCE_2_FAST_MODEL_ID,
