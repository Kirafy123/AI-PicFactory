...
export const KIE_WAN_27_I2V_MODEL_ID = 'kie/wan-2-7-i2v';

export const videoModel: VideoModelDefinition = {
  id: KIE_WAN_27_I2V_MODEL_ID,
  mediaType: 'video',
  displayName: 'Wan 2.7 I2V (KIE)',
  providerId: 'kie',
  description: 'KIE · Wan 2.7 图生视频，支持首帧/末帧控制',
  eta: '3-5min',
  ...
  resolveRequest: ({ referenceImageCount }) => ({
    requestModel: KIE_WAN_27_I2V_MODEL_ID,
